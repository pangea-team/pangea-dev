...
import FeedUploadFlow from '@/app/(with-header)/feed/upload/_components/FeedUploadFlow';
...
export default async function FeedUploadPage() {
  ...
  return (
    <main className="flex min-h-0 flex-1 flex-col">
      <div className="mx-auto flex w-full max-w-[960px] flex-1 flex-col px-page-x pb-page-x">
        ...
        <div className="flex flex-1 flex-col pt-section-sm">
          <FeedUploadFlow books={books ?? []} />
        </div>
      </div>
    </main>
  );
