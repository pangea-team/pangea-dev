...
export default function AddFeedCard() {
  return (
    <div className="flex aspect-3/5 w-full max-w-feed-card-w shrink-0 flex-col items-center justify-center bg-surface-50 shadow-card transition-shadow duration-200 ease-out has-[a:hover]:shadow-card">
      <Link
